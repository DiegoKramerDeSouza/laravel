                        ...
                        <tbody>
                            @foreach($cursos as $curso)
                                <tr>
                                    ...
                                    <td class='right'>
                                        <a class='load btn-flat waves-effect waves-red red-text text-darken-3 modal-trigger' href='#confirm-message-{{$curso->id}}'><i class='fa fa-trash-o'></i> deletar</a>
    ...
    @foreach($cursos as $curso)
        <div id='confirm-message-{{$curso->id}}' class='modal'>
            <div class='modal-content'>
                ...
                <div class='right'>
                    <br>
                    <a class='load btn-flat waves-effect waves-red red-text darken-3' href='{{ route('admin.cadastro.cursos.deleta', $curso->id) }}'><i class='fa fa-trash-o'></i> Deletar</a>
