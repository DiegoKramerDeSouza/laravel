...
@section('content')
    <div class='card z-depth-5'>
        <div class='card-content'>
            <h3 class='card-title green-text'>{!! $default->novoIcon !!} Novo Curso:</h3>
            ...
            @else
                <br>
                <br>
                <h5 class='center grey-text'>{!! $default->cancelRedIcon !!} Não há módulos cadastrados!<br>Cadastre novos módulos para criar um novo curso.</h5>
            @endif
        </div>
    </div>
@endsection
