...
@section('content')
    <div class='card z-depth-5'>
        <div class='card-content'>
            <h3 class='card-title green-text'>{!! $novoIcon !!} Nova Instituição:</h3>
            ...
            <form class='' action='{{ route('admin.cadastro.escolas.salva') }}' method='post' enctype="multipart/form-data">
                ...
                <div class='card-action' align='right'>
                    ...
                    <button id='save' type='submit' class='load btn-flat green-text text-darken-2 waves-effect waves-green'>{!! $applyIcon !!} Salvar</button>
                </div>
            </form>
        </div>
    </div>
