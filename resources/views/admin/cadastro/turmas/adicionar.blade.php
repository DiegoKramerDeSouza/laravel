    ...
    <div class='card z-depth-5'>
        <div class='card-content'>
            ...
            @if(count($escolas) > 0)
                <form class='' action='{{ route('admin.cadastro.turmas.salva') }}' method='post' enctype="multipart/form-data">
                    ...
                    <div class='card-action' align='right'>
                        <a href='{{ route('admin.cadastro.turmas', ['page' => '1']) }}' class='load btn-flat red-text text-darken-3 waves-effect waves-red'><i class='fa fa-times'></i> Cancelar</a>
            ...
            @else
                <br>
                <br>
                <h5 class='center grey-text'><i class='fa fa-times red-text text-darken-3'></i> Não há escolas cadastradas!<br>Cadastre novas escolas para criar uma nova turma.</h5>
            @endif
        </div>
    </div>
@endsection
