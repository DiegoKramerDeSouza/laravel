    ...
    <div class='card z-depth-5'>
        <div class='card-content'>
            ...
            @if(isset($perfis->id))
                <form class='' action='{{ route('admin.cadastro.perfis.atualiza', $perfis->id) }}' method='post' enctype="multipart/form-data">
                    ...
                    <div class='card-action' align='right'>
                        <a href='{{ route('admin.cadastro.perfis', ['page' => '1']) }}' class='load-cancel btn-flat red-text text-darken-3 waves-effect waves-red'>{!! $cancelIcon !!} Cancelar</a>
            ...
            @else
                <br>
                <br>
                <h5 class='center grey-text'>{!! $cancelRedIcon !!} Perfil não localizado!</h5>
            @endif
        </div>
    </div>
@endsection