<div class='row'>
    <div class='input-field col s12 m6'>
        <input class='validate' require type='text' name='name' id='name' value='{{ isset($user->name) ? $user->name : ''}}'>
        <label for='name'><i class='fa fa-user-circle'></i> Nome</label>
    </div>

    <div class='input-field col s12 m6'>
        <input class='validate' require type='text' name='email' id='email' value='{{ isset($user->email) ? $user->email : ''}}'>
...
<div class='row'>
    <div class='input-field col s12 m6'>
        <input class='validate' require {{ isset($user->password) ? 'disabled' : ''}} type='password' name='password' id='password' value='{{ isset($user->password) ? '1234567890' : ''}}'>
        <label for='password'><i class='fa fa-lock'></i> Senha</label>
    </div>

    <div class='input-field col s12 m6'>
        <input class='validate' require {{ isset($user->password) ? 'disabled' : ''}} type='password' name='confpassword' id='confpassword' value='{{ isset($user->password) ? '1234567890' : ''}}'>
...
<div class='row'>
    <div class='input-field col s12 m6'>
        <select id='escola_id' require name='escola_id'>
    ...
    <div class='input-field col s12 m6'>
        <select id='group' require name='group'>
            @if(isset($userdata->group))
