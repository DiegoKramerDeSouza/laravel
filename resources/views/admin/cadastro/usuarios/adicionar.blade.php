...
@section('content')
    <div class='card z-depth-5'>
        <div class='card-content'>
            <h3 class='card-title green-text'>{!! $novoIcon !!} Novo Usuário:</h3>
            ...
            @else
                <br>
                <br>
                <h5 class='center grey-text'>{!! $cancelRedIcon !!} Não há escolas cadastradas!<br>Cadastre novas escolas para criar um usuário.</h5>
            @endif
        </div>
    </div>
@endsection
