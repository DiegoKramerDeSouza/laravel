        ...
        <div class='card-content'>
            @if(Auth::guest())
                <div class='row center container'>
                    <h2 class='card-title' align='left'>
                        <b>Bem vindo ao <span class='blue-text'>{!! $default->logo !!}</span>.</b><br>
                        Efetue seu acesso para começar.
                    </h2>
                    <div class='divider'></div>
                    <div class='row'>
                        <h3 class='card-title' align='left'>{!! $default->loginBlueIcon !!} Login</h3>
                        <form class='' action='{{ route('login.access') }}' method='post' enctype="multipart/form-data">
                            ...
                            <div class='row'>
                                <div class='input-field col s12 m6'>
                                    ...
                                    <label for='login'>{!! $default->userOIcon !!} Usuário</label>
                                </div>
                                <div class='input-field col s12 m6'>
                            ...
                            <div class='card-action' align='right'>
                                <button id='access' type='submit' class='load btn-flat green-text text-darken-2 waves-effect waves-green'>Entrar {!! $default->signInIcon !!}</button>
                            </div>
                        </form>
                    </div>
                </div>
            ...
            @else
                <div class='row center'>
                    <h2 class='card-title' align='left'>
                        <b>Bem vindo(a) <br><span class='blue-text'>{!! $default->loginIcon !!} {{ Auth::user()->name }}</span>.</b><br>
                    </h2>
                    <div class='divider'></div>
                    <br>
                    <div class='row grey-text text-darken-3' align='left'>
                        <div class='col s12 m4'>
                            <div class='blue-text center'>
                                <a href="{{ route('salas') }}" title='Transmita'>{!! $default->transmitLargeIcon !!}</a>
                            </div>
                        ...
                        <div class='col s12 m4'>
                            <div class='blue-text center'>
                                <a href="{{ route('salas') }}" title='Compartilhe'>{!! $default->shareLargeIcon !!}</a>
                            </div>
                        ...
                        <div class='col s12 m4'>
                            <div class='blue-text center'>
                                <a href="{{ route('admin.cadastro') }}" title='Configure'>{!! $default->peopleLargeIcon !!}</a>
                            </div>
